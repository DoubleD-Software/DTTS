	...
	{#if classEntry !== null}
		<div class="text-white flex-row pb-2 text-lg">
			...
			<div class="flex-row flex font-bold">
				<p><span class="text-tx-gray font-normal">Ø-Note:</span> {classEntry.sprint.avg_grade.replace('.', ',')}
				</p>
			...
			<div class="flex-row flex font-bold">
				<p><span
					class="text-tx-gray font-normal">Ø-Note:</span> {classEntry.lap_run.avg_grade.replace('.', ',')}</p>
				<p class="absolute left-[50%]"><span
			...
			<p class="font-bold"><span
				class="text-tx-gray font-normal">Ø-Note:</span> {classEntry.global_avg_grade.replace('.', ',')}</p>
		</div>
